...
#
# Usage: ./kubeconfig_generator.sh <service_account_name> <namespace_name>
...
kubectl config set clusters.cluster.certificate-authority-data `cat ca.crt`
...
kubectl config set-context $2 --cluster=cluster --user=$USER --namespace=$2
